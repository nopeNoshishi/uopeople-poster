...
use tower_http::{trace, trace::TraceLayer, classify::{SharedClassifier, ServerErrorsAsFailures}};

pub fn trace_middleware<M>() -> TraceLayer<SharedClassifier<ServerErrorsAsFailures>> {
