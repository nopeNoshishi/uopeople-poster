...
{
	if (region.aj.P === region.aq.P)
	{
		return 'on line ' + region.aj.P;
	}
	return 'on lines ' + region.aj.P + ' through ' + region.aq.P;
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {as: fragment, av: host, aA: path, aC: port_, aE: protocol, aF: query};
	});
...
var $author$project$Main$GotInfos = function (a) {
	return {$: 13, a: a};
};
...
var $author$project$Main$Information = F4(
	function (id, url, tag, title) {
		return {ae: id, h: tag, i: title, d: url};
	});
var $elm$json$Json$Decode$field = _Json_decodeField;
var $elm$json$Json$Decode$int = _Json_decodeInt;
var $elm$json$Json$Decode$map4 = _Json_map4;
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Main$infoDecoder = A5(
	$elm$json$Json$Decode$map4,
	$author$project$Main$Information,
	A2($elm$json$Json$Decode$field, 'id', $elm$json$Json$Decode$int),
	A2($elm$json$Json$Decode$field, 'url', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'tag', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'title', $elm$json$Json$Decode$string));
var $elm$json$Json$Decode$list = _Json_decodeList;
var $author$project$Main$infosDecoder = $elm$json$Json$Decode$list($author$project$Main$infoDecoder);
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{aV: false, X: r.X, _: r._, at: r.at, ax: r.ax, aO: r.aO, aP: r.aP, d: r.d}));
};
var $author$project$Main$getInformation = $elm$http$Http$request(
	{
		X: $elm$http$Http$emptyBody,
		_: A2($elm$http$Http$expectJson, $author$project$Main$GotInfos, $author$project$Main$infosDecoder),
		at: _List_fromArray(
			[
		...
		d: 'http://localhost:8080/api/v1/info/all'
	});
var $author$project$Main$initForm = {h: '', i: '', d: 'http;//'};
var $emilianobovetti$elm_toast$Toast$Private = $elm$core$Basics$identity;
var $emilianobovetti$elm_toast$Toast$tray = {Y: 0, v: _List_Nil};
var $author$project$Main$init = function (_v0) {
	var model = {j: $author$project$Main$initForm, N: _List_Nil, k: $author$project$Main$initForm, aa: _List_Nil, J: false, a: '', Q: _List_Nil, ac: $elm$core$Maybe$Nothing, G: $emilianobovetti$elm_toast$Toast$tray};
	return _Utils_Tuple2(
		model,
		$elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[$author$project$Main$getInformation])));
};
	...
	function (model, toast) {
		...
		return A2(
			...
			A2(
				...
				A2($emilianobovetti$elm_toast$Toast$onEnter, id, toast.ab)),
			_Utils_update(
				model,
				{Y: id + 1, v: toasts}));
	});
...
var $author$project$Main$GotDeleted = function (a) {
	return {$: 12, a: a};
};
...
var $author$project$Main$deleteJson = function (information) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'id',
				$elm$json$Json$Encode$int(information.ae))
			]));
};
...
var $author$project$Main$ResponseMessage = function (message) {
	return {a: message};
};
var $author$project$Main$responseMsgDecoder = A2(
	$elm$json$Json$Decode$map,
	$author$project$Main$ResponseMessage,
	A2($elm$json$Json$Decode$field, 'message', $elm$json$Json$Decode$string));
var $author$project$Main$deleteInformation = function (information) {
	var json = $author$project$Main$deleteJson(information);
	return $elm$http$Http$request(
		{
			X: $elm$http$Http$jsonBody(json),
			_: A2($elm$http$Http$expectJson, $author$project$Main$GotDeleted, $author$project$Main$responseMsgDecoder),
			at: _List_fromArray(
				[
					A2($elm$http$Http$header, 'Access-Control-Allow-Origin', '*')
				]),
			...
			aO: $elm$core$Maybe$Nothing,
			aP: $elm$core$Maybe$Nothing,
			d: 'http://localhost:8080/api/v1/info/delete'
		});
};
...
var $emilianobovetti$elm_toast$Toast$new = F2(
	function (lifespan, content) {
		return {A: 0, ao: content, Z: 0, ae: -1, s: 1, ab: lifespan, u: 0};
	});
var $emilianobovetti$elm_toast$Toast$expireIn = function (ttl) {
	return $emilianobovetti$elm_toast$Toast$new(
		$emilianobovetti$elm_toast$Toast$ExpireIn(ttl));
};
var $elm$core$Platform$Cmd$map = _Platform_map;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Main$GotCreated = function (a) {
	return {$: 10, a: a};
};
var $elm$json$Json$Encode$string = _Json_wrap;
var $author$project$Main$formJson = function (form) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				...
				_Utils_Tuple2(
				'url',
				$elm$json$Json$Encode$string(form.d)),
				_Utils_Tuple2(
				'tag',
				$elm$json$Json$Encode$string(form.h)),
				_Utils_Tuple2(
				'title',
				$elm$json$Json$Encode$string(form.i))
			]));
};
var $elm$http$Http$post = function (r) {
	return $elm$http$Http$request(
		{X: r.X, _: r._, at: _List_Nil, ax: 'POST', aO: $elm$core$Maybe$Nothing, aP: $elm$core$Maybe$Nothing, d: r.d});
};
var $author$project$Main$postInforation = function (_v0) {
	var form = _v0;
	var json = $author$project$Main$formJson(form);
	return $elm$http$Http$post(
		{
			X: $elm$http$Http$jsonBody(json),
			_: A2($elm$http$Http$expectJson, $author$project$Main$GotCreated, $author$project$Main$responseMsgDecoder),
			d: 'http://localhost:8080/api/v1/info/create'
		});
};
var $author$project$Main$GotUpdated = function (a) {
	return {$: 11, a: a};
};
var $author$project$Main$editFormmJson = F2(
	function (info_id, form) {
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					'id',
					$elm$json$Json$Encode$int(info_id)),
					_Utils_Tuple2(
					'url',
					$elm$json$Json$Encode$string(form.d)),
					_Utils_Tuple2(
...
var $author$project$Main$putInforation = F2(
	function (info_id, _v0) {
		var form = _v0;
		var json = A2($author$project$Main$editFormmJson, info_id, form);
		return $elm$http$Http$post(
			{
				X: $elm$http$Http$jsonBody(json),
				_: A2($elm$http$Http$expectJson, $author$project$Main$GotUpdated, $author$project$Main$responseMsgDecoder),
				d: 'http://localhost:8080/api/v1/info/update'
			});
	});
	...
	if (_v0.$ === 2) {
		...
		return _List_fromArray(
			[
				...
				$emilianobovetti$elm_toast$Toast$delay,
				ttl,
				$emilianobovetti$elm_toast$Toast$PrepareExit(toast.ae))
			]);
	} else {
		return _List_Nil;
	}
...
var $emilianobovetti$elm_toast$Toast$handlePrepareExit = function (toast) {
	return ((!toast.s) || (toast.A > 0)) ? $emilianobovetti$elm_toast$Toast$withoutCmd(
		_Utils_update(
			toast,
			{A: toast.A - 1})) : _Utils_Tuple2(
		toast,
		$emilianobovetti$elm_toast$Toast$fire(
			A2($emilianobovetti$elm_toast$Toast$Transition, 2, toast.ae)));
};
...
var $emilianobovetti$elm_toast$Toast$handleStartExit = function (toast) {
	return _Utils_Tuple2(
		...
		A2(
			$emilianobovetti$elm_toast$Toast$delay,
			toast.Z,
			$emilianobovetti$elm_toast$Toast$Remove(toast.ae)));
};
...
var $emilianobovetti$elm_toast$Toast$updateToastWithCmd = F3(
	function (updater, id, model) {
		var doUpdate = function (toast) {
			return _Utils_eq(toast.ae, id) ? $elm$core$Maybe$Just(
		...
		return A3(
			...
			A3($emilianobovetti$elm_toast$Toast$findToastAndUpdate, doUpdate, _List_Nil, model.v));
	});
...
var $author$project$Main$Tag = 1;
var $author$project$Main$Title = 2;
var $author$project$Main$URL = 0;
var $author$project$Main$fieldsToValidate = _List_fromArray(
	[0, 1, 2]);
var $author$project$Main$Trimmed = $elm$core$Basics$identity;
var $elm$core$String$trim = _String_trim;
var $author$project$Main$trimFields = function (form) {
	return {
		h: $elm$core$String$trim(form.h),
		i: $elm$core$String$trim(form.i),
		d: $elm$core$String$trim(form.d)
	};
};
var $author$project$Main$InvalidEntry = F2(
	function (a, b) {
		return {$: 0, a: a, b: b};
	});
var $author$project$Main$validateField = F2(
	function (_v0, field) {
		...
		return A2(
			$elm$core$List$map,
			$author$project$Main$InvalidEntry(field),
			function () {
				switch (field) {
					case 0:
						return $elm$core$String$isEmpty(form.d) ? _List_fromArray(
							['url can\'t be blank.']) : _List_Nil;
					case 1:
						return $elm$core$String$isEmpty(form.h) ? _List_fromArray(
							['tag can\'t be blank.']) : _List_Nil;
					default:
						return $elm$core$String$isEmpty(form.i) ? _List_fromArray(
							['title can\'t be blank.']) : _List_Nil;
				}
			}());
	});
var $author$project$Main$validate = function (form) {
	var trimmedForm = $author$project$Main$trimFields(form);
	var _v0 = A2(
		$elm$core$List$concatMap,
		$author$project$Main$validateField(trimmedForm),
		$author$project$Main$fieldsToValidate);
	if (!_v0.b) {
		...
		switch (msg.$) {
			...
			case 5:
				...
				return _Utils_Tuple2(
					...
					$elm$core$Platform$Cmd$none);
			case 6:
				var _v1 = $author$project$Main$validate(model.k);
				if (!_v1.$) {
					var validForm = _v1.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{Q: _List_Nil}),
						$author$project$Main$postInforation(validForm));
				} else {
					var problems = _v1.a;
					return _Utils_Tuple2(
						_Utils_update(
			...
			case 7:
				var info_id = msg.a;
				var _v2 = $author$project$Main$validate(model.j);
				if (!_v2.$) {
					var validForm = _v2.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{N: _List_Nil}),
						A2($author$project$Main$putInforation, info_id, validForm));
				} else {
					var problems = _v2.a;
					return _Utils_Tuple2(
						_Utils_update(
			...
			case 8:
				return _Utils_Tuple2(model, $author$project$Main$getInformation);
			case 9:
				var information = msg.a;
				return _Utils_Tuple2(
					model,
					$author$project$Main$deleteInformation(information));
			case 10:
				var result = msg.a;
				if (!result.$) {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{k: $author$project$Main$initForm, a: response.a}),
						$elm$core$Platform$Cmd$batch(
							_List_fromArray(
								[
									$author$project$Main$getInformation,
				...
				if (!result.$) {
					...
					return _Utils_Tuple2(
						...
						A2(
							...
							0,
							$author$project$Main$AddToast(
								{r: 0, a: '削除中ににエラーが発生しました。'})));
				}
			case 13:
				var result = msg.a;
				if (!result.$) {
					var informations = result.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{aa: informations}),
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							j: _Utils_update(
								editForm,
								{h: information.h, i: information.i, d: information.d}),
							J: true,
							ac: $elm$core$Maybe$Just(information)
						}),
					$elm$core$Platform$Cmd$none);
			case 15:
				return _Utils_Tuple2(
			...
			case 17:
				...
				var _v7 = A2(
					...
					model.G,
					A2($emilianobovetti$elm_toast$Toast$expireIn, 3000, content));
				var tray = _v7.a;
				var tmesg = _v7.b;
				return _Utils_Tuple2(
					_Utils_update(
			...
			default:
				var tmsg = msg.a;
				var _v8 = A2($emilianobovetti$elm_toast$Toast$update, tmsg, model.G);
				var tray = _v8.a;
				var newTmesg = _v8.b;
				return _Utils_Tuple2(
					_Utils_update(
...
var $author$project$Main$CancelEdit = {$: 15};
var $author$project$Main$Submit = {$: 6};
var $author$project$Main$SubmitEdited = function (a) {
	return {$: 7, a: a};
};
var $author$project$Main$UpdateSelectedTag = function (a) {
	return {$: 4, a: a};
};
var $author$project$Main$UpdateSelectedTitle = function (a) {
	return {$: 5, a: a};
};
var $author$project$Main$UpdateSelectedUrl = function (a) {
	return {$: 3, a: a};
};
var $author$project$Main$UpdateTag = function (a) {
	return {$: 1, a: a};
};
...
var $emilianobovetti$elm_toast$Toast$config = function (toAppMsg) {
	return {B: _List_Nil, C: _List_Nil, O: _List_Nil, al: toAppMsg, T: _List_Nil, U: _List_Nil, ad: 'div'};
};
	...
	function (cfg, toast) {
		return $elm$core$List$concat(
			_List_fromArray(
				[
					cfg.T,
					A2($emilianobovetti$elm_toast$Toast$interactionAttributes, cfg, toast.s),
					A2($emilianobovetti$elm_toast$Toast$transitionAttributes, cfg, toast.u),
					A2($emilianobovetti$elm_toast$Toast$defaultAttributes, cfg.al, toast.ae)
				]));
	});
var $emilianobovetti$elm_toast$Toast$toInfo = function (toast) {
	return {ao: toast.ao, ae: toast.ae, s: toast.s, u: toast.u};
};
var $emilianobovetti$elm_toast$Toast$renderToast = F3(
	function (viewer, cfg, toast) {
		return _Utils_Tuple2(
			'toast-' + $elm$core$String$fromInt(toast.ae),
			A2(
				viewer,
...
var $author$project$Main$DeleteInfo = function (a) {
	return {$: 9, a: a};
};
var $author$project$Main$EditInfo = function (a) {
	return {$: 14, a: a};
};
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('card__imgframe')
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$src('uopeople-logo.png'),
									$elm$html$Html$Attributes$class('card__img'),
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('card__textbox')
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('card__titletext')
								]),
							_List_fromArray(
								[
									$elm$html$Html$text(information.i)
								])),
							A2(
							$elm$html$Html$div,
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('card__overviewtext')
								]),
							_List_fromArray(
								[
									$elm$html$Html$text(information.h)
								])),
							A2(
							...
							_List_fromArray(
								[
									...
									$author$project$Main$EditInfo(information))
								]),
							_List_fromArray(
								[
							...
							_List_fromArray(
								[
									$elm$html$Html$Events$onClick(
									$author$project$Main$DeleteInfo(information))
								]),
							_List_fromArray(
								[
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$href(information.d)
								]),
							_List_fromArray(
								[
									$elm$html$Html$text('記事を見る')
								]))
						]))
				]));
	});
...
var $author$project$Main$toastStyles = function (toast) {
	var background = function () {
		...
		switch (_v0) {
			case 0:
				return A2($elm$html$Html$Attributes$style, 'background', '#f77');
			case 2:
				return A2($elm$html$Html$Attributes$style, 'background', '#7f7');
			default:
				return A2($elm$html$Html$Attributes$style, 'background', '#77f');
		}
	}();
	return _List_fromArray(
		[
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('UOPEOPLE LIFE IS GOING BETTER')
							])),
						$elm$html$Html$text('Uoeople まとめ')
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('input-block')
					]),
				_List_fromArray(
					[
						A4($author$project$Main$viewInput, 'url', 'URL', model.k.d, $author$project$Main$UpdateUrl),
						A2($elm$html$Html$br, _List_Nil, _List_Nil),
						A4($author$project$Main$viewInput, 'tag', 'Tag', model.k.h, $author$project$Main$UpdateTag),
						A2($elm$html$Html$br, _List_Nil, _List_Nil),
						A4($author$project$Main$viewInput, 'title', 'Title', model.k.i, $author$project$Main$UpdateTitle),
						A2(
						$elm$html$Html$ul,
						_List_fromArray(
							[
						...
						A2($elm$core$List$map, $author$project$Main$viewProblem, model.Q))
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
				...
				if (model.J) {
					...
					if (!_v0.$) {
						...
						return A2(
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('edit-card')
								]),
							_List_fromArray(
								[
									A4($author$project$Main$viewInput, 'url', 'Url', model.j.d, $author$project$Main$UpdateSelectedUrl),
									A2($elm$html$Html$br, _List_Nil, _List_Nil),
									A4($author$project$Main$viewInput, 'title', 'Title', model.j.h, $author$project$Main$UpdateSelectedTag),
									A2($elm$html$Html$br, _List_Nil, _List_Nil),
									A4($author$project$Main$viewInput, 'title', 'Title', model.j.i, $author$project$Main$UpdateSelectedTitle),
									A2($elm$html$Html$br, _List_Nil, _List_Nil),
									A2(
									$elm$html$Html$ul,
									_List_fromArray(
									...
									A2($elm$core$List$map, $author$project$Main$viewProblem, model.N)),
									A2(
									$elm$html$Html$button,
									_List_fromArray(
										[
											$elm$html$Html$Events$onClick(
											$author$project$Main$SubmitEdited(selected.ae))
										]),
									_List_fromArray(
										[
											$elm$html$Html$text('編集')
...
var $author$project$Main$main = $elm$browser$Browser$element(
	{a1: $author$project$Main$init, bb: $author$project$Main$subscriptions, bc: $author$project$Main$update, bd: $author$project$Main$view});
